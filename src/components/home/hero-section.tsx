...
export default function HeroSection() {
	return (
		<section className="relative flex items-center min-h-screen overflow-hidden bg-gradient-hero">
			<div className="absolute inset-0 overflow-hidden">
				<div className="-top-40 -right-40 absolute w-96 h-96 rounded-full bg-primary-200/30 blur-3xl" />
				<div className="-bottom-40 -left-40 absolute w-96 h-96 rounded-full bg-primary-300/20 blur-3xl" />
			</div>
				...
				<div className="items-center gap-12 grid lg:grid-cols-2">
					<div className="lg:text-left text-center" data-aos="fade-right">
						...
						>
							...
							directly to your dashboard. You focus on care.
						</p>
					...
					<div data-aos="fade-left" data-aos-delay="300" className="relative">
						<div className="float-animation relative">
							<Image
								...
								className="w-full max-w-lg mx-auto rounded-3xl shadow-medium"
								priority
							/>
